...
from models.deeponet.network import DeepONet3D

class DeepONet(BaseLightningModule):
    def __init__(self, input_channels_func, input_channels_loc, output_channels, branch_net_layers, trunk_net_layers, modes, loss=nn.MSELoss(), lr=1e-4, plot_path='./plots/', log_file='DeepONet_log.txt'):
        ...
        self.modes = modes
        self.loss = loss
        self.model = DeepONet3D(input_channels_func = self.input_channels_func, input_channels_loc = self.input_channels_loc, 
